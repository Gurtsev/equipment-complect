...
const CATEGORIES: EquipmentCategory[] = ['camera', 'microphone', 'light', 'computer', 'laptop', 'tv', 'audio', 'accessory', 'optics', 'phone', 'stand', 'mount', 'network', 'cable', 'furniture', 'prop', 'tool'];
