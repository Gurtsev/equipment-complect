...
RPC из 030 — обязательный production-контракт. Если функция отсутствует в PostgREST
schema cache, frontend завершает операцию ошибкой и не выполняет неатомарные
прямые записи. Создание, редактирование, изменение состава, активация и завершение
проекта вместе со статусами оборудования и аудитом выполняются транзакционно.
