...
- Мобильный адаптив
- Единая бренд-тема Megapolis Inventory по `megapolis-platform/brand/BRAND.md`:
  канонический SVG, lockup, зелёная палитра и Steppe/Inter typography stack
- Физическая инвентаризация помещений: снимок ожидаемого состава, QR/ручное
  сканирование, Realtime-прогресс, расхождения и завершение сессии (миграция 033)
...
- Безопасное удаление планируемых и завершённых проектов; активный проект сначала
  требуется завершить (миграция 034 применена на production 2026-08-23)
...
- Vitest: 52 теста сервисной логики
...
Миграция `033_inventory_sessions.sql` применена на production 2026-08-22.
Серверный контракт сессий, снимков, сканирования и Realtime доступен frontend.
...
| 033_inventory_sessions | сессии физической инвентаризации, снимки, сканы и Realtime |
| 034_atomic_project_delete | атомарное удаление проекта и снятие резервов |
