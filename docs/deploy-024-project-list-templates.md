...
Frontend совместим со старой схемой: до применения миграции обычная история проектов
продолжает работать, а кнопка «Из списка» скрыта. Тем не менее миграцию следует
применить до пользовательской проверки новой функции.
