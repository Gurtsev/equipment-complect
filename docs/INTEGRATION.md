...
- ✅ Чистый передеплой в схему `inventory` (миграции 001–020, `combined_001_023.sql`)
...
- [x] **3. Переехали все таблицы из `public` → схему `inventory`** — чистый передеплой выполнен, миграции 001–020 прогнаны (`combined_001_023.sql`)
...
- [x] Чистый передеплой: БД очищена, миграции 001–020 прогнаны (`combined_001_023.sql`)
