...
RPC из 029 — обязательный production-контракт. Если функция отсутствует в PostgREST
schema cache, frontend завершает операцию ошибкой и не выполняет неатомарные
прямые записи.
